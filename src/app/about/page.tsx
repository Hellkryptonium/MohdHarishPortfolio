...
const AboutPage = () => {
  return (
    <div className="pt-16">
      <motion.section 
        className="min-h-screen py-20 px-4 md:px-8 flex items-center justify-center bg-gradient-to-br from-background to-muted overflow-hidden"
        ...
        <Card className="container mx-auto max-w-3xl bg-card/60 backdrop-blur-md border-accent/20">
          <CardContent className="pt-8 px-6 md:px-10">
            ...
            >
              ...
              >
                <img 
                  src="/assets/images/placeholders/profile-placeholder.png"
                  alt="Mohd Harish"
